...
public class MathGameScript : MonoBehaviour
{
    ...
    IEnumerator the()
    {
        baldiAudio.PlayOneShot(glitch);
        gc.learnMusic.Stop();
        black.SetActive(true);
        yield return new WaitForSeconds(0.5f);
        namehere.SetActive(true);
        yield return new WaitForSeconds(1.5f);
        gc.CrackWall();
        gc.toJumpscare.gameObject.SetActive(true);
        Deactivate();
    }
    IEnumerator mangoCoro()
    {
    ...
    private void Start()
    {
        mango.pitch = UnityEngine.Random.Range(0.5f, 1.5f);
    ...
    public void Deactivate()
    {
        ...
        if (gc.notebooks >= 2)
        {
            ...
            if (this.gc.mode == "story")
                this.baldiScript.GetAngry(1.35f);
            else if (this.gc.mode == "trull")
                this.baldiScript.GetAngry(1.75f);
            else if (this.gc.mode == "endless")
